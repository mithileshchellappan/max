...
const MaxLogo = ({ width = 72 }) => {
  return (
    <svg width={width} viewBox="0 0 72 72" role="img" aria-label="Max" xmlns="http://www.w3.org/2000/svg">
      <path
        fill="#101824"
        d="M36 5.8 24.7 13 14.9 12.4 12.6 27.1 6.1 35.6 13.4 48.7 36 66.2 58.6 48.7 65.9 35.6 59.4 27.1 57.1 12.4 47.3 13z"
      />
      ...
      <path stroke="#F6EFE2" strokeLinecap="round" strokeWidth="2.2" d="M18.8 49.8 6.9 51.9M20.7 53.1 10 57.7M53.2 49.8l11.9 2.1M51.3 53.1 62 57.7" />
    </svg>
  );
};
